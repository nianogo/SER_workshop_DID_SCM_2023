...
In this new dataset, there are 50 states, 15 of which are treated and 35 controls
...
```
This quantity above is not giving us the group-specific overall ATT. We can obtain
the overall ATT by estimating the effect in each unit (state) and then pool the estimates as done bellow  
